...
export class ProductionPlanWoodItemsController {
  constructor(private readonly productionPlanWoodItemsService: ProductionPlanWoodItemsService) {}

  @Post()
  create(@Body() createProductionPlanWoodItemDto: CreateProductionPlanWoodItemDto) {
    return this.productionPlanWoodItemsService.create(createProductionPlanWoodItemDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateProductionPlanWoodItemDto: UpdateProductionPlanWoodItemDto) {
    return this.productionPlanWoodItemsService.update(+id, updateProductionPlanWoodItemDto);
  }
