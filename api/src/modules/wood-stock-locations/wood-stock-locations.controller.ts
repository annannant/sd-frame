...
export class WoodStockLocationsController {
  constructor(private readonly woodStockLocationsService: WoodStockLocationsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateWoodStockLocationDto: UpdateWoodStockLocationDto) {
    return this.woodStockLocationsService.update(+id, updateWoodStockLocationDto);
  }
