...
const fn = () => {
  const list = uniqBy(attributeList, 'attributeName')
  for (const item of list) {
    let sql =
      "INSERT INTO `sd-frame-db`.`attribute` (`code`, `name`, `description`) VALUES ('#attributeCode', '#attributeName', '#attributeDescription');"
